...
SOLVER := app_SOLVER
app_SOLVER_FILES := new/tools/tadmissibilitySolver.cpp $(subst ${SRC_DIR}/, , $(shell find ${SRC_DIR}/new/code/ -name *.cpp)) $(subst ${SRC_DIR}/, , $(shell find ${SRC_DIR}/new/my_libs/ -name *.cpp))
...
ALL_APP := ${SOLVER} ${FACTOR-CALCULATOR} ${CREATE} ${GENERATE} ${BF-SEQ} ${BF-ADJACENCY} ${BF-EDGES} ${BF-CYCLES} ${HR-H1v1} ${HR-H1v2} ${HR-H1v3} ${HR-H1v4} ${HR-H2v1} ${HR-H2v2} ${HR-H3v1} ${HR-H3v2} ${HR-H4v1} ${HR-H4v2r1} ${HR-H4v2r2} ${HR-H4v2r3}
